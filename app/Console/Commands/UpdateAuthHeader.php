...
class UpdateAuthHeader extends Command
{
    ...
    public function getValidateDate($user)
    {
        ...
        $dateCreated = Carbon::createFromFormat('m/d/Y h:i:s A', $lastCreateDate_)->addSeconds(random_int(300,600));
        ...
        if ($dateCreated >= $start && $dateCreated <= $end) {
            ...
            $nDate = Carbon::createFromFormat('m/d/Y h:i:s A',$newDate)->addSeconds(random_int(300,600));
